...
const show_language_docs = () => {
  ...
  disclaimer.innerText = "Here listed are only extra functions, built-in functions and those of the math and sci package are also supported. Do note that some functions only take in floats and might not be recognized if used with integers. In most cases multiplying by 1.0 fixes that issue!";
